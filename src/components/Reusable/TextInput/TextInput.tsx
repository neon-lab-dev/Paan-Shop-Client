    ...
    return (
      <div className="flex flex-col gap-2 font-Inter w-full">
        ...
        <input
          ...
          ref={ref}
          disabled={isDisabled}
          className={`px-[18px] py-[14px] rounded-lg bg-neutral-70 border focus:outline-none focus:border-primary-10 transition duration-300 ${error ? "border-red-500" : "border-neutral-light-40"
            }`}
          {...rest}
        />
        {error?.message && (
